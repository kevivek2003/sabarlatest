...
@CucumberOptions(plugin = { "com.cucumber.listener.ExtentCucumberFormatter:src\\test\\resource\\reports\\report.html",		
		...
		features = "src\\test\\java\\org\\adactin_feature", 
        glue = "org.adactin_stepDefinition", dryRun = false, 
        tags = "@tc_1", strict = true, 
        monochrome = true)
...
public class TestRunner  {
	...
	public static void driverQuit() {
		Reporter.loadXMLConfig(new File("src\\test\\resource\\com\\configuration\\extend-config.xml"));	
		driver.quit();
	}
