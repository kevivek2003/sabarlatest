...
Scenario Outline: TC-2.To verify whether the check-out date field accepts a 
 ...
 @tc_3
 Scenario Outline: TC-3.To check if error is reported if check-out date field is in the past
 ...
 @tc_4
 Scenario Outline: TC-4.To verify whether locations in Select Hotel page are displayed according 
 ...
 @tc_5
  Scenario Outline:TC-. To verify whether the total price (excl.GST) is calculated as “price per night * no. of nights*
                     no of rooms
